...
interface ScorerCardProps extends HTMLAttributes<HTMLDivElement> {
  player: TopPlayerData;
  index: number;
}

const ScorerCard = forwardRef<HTMLDivElement, ScorerCardProps>(
...
ScorerCard.displayName = 'ScorerCard';
