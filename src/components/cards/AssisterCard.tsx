...
interface AssisterCardProps extends HTMLAttributes<HTMLDivElement> {
  player: TopPlayerData;
  index: number;
}

const AssisterCard = forwardRef<HTMLDivElement, AssisterCardProps>(
...
AssisterCard.displayName = 'AssisterCard';
