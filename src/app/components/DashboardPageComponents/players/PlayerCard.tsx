...
// tiny helper so weird/nullable values become safe numbers
...
export default function PlayerCard({ player, onEdit, onDelete }: Props) {
  // player_statistics is normalized to an array by the container
      ...
      <div className="flex items-start justify-between">
        <div>
          <p className="text-white font-semibold">
            ...
            <span className="text-white/40 text-xs">#{player.id}</span>
          </p>
