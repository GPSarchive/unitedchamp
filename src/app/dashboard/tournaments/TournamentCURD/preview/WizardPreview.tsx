//app/dashboard/tournaments/TournamentCURD/preview/preview/WizardPreview.tsx
"use client";
...
export default function WizardPreview({
  ...
  hideActions = false, // <-- NEW: control showing the top action bar
}: {
  ...
  return (
    <div className="space-y-6">
      {/* Actions bar (Back / Regenerate / Continue) — hidden when hideActions is true */}
      {!hideActions && (
