...
export default async function Page({
  ...
  // Tournament logo raw value (support both shapes)
  const tournamentLogoRaw: unknown =
    (match as any)?.tournament?.logo ??
    (match as any)?.tournament_logo ??
    null;
            ...
            <div className={`${styles.cupFadeUp} pointer-events-none select-none`}>
              ...
              {tournamentLogo ? (
                <div className="mb-3 flex justify-center">
                  <Image
                    src={tournamentLogo}
                    alt={(match as any)?.tournament?.name ?? "Tournament logo"}
                    width={160}
                    height={160}
              ...
              >
                ...
                <g>
                  ...
                  />
                  <path
                    d="M106 34c6 0 10 5 9 10-1 6-6 10-12 11-4 .7-8-2-8-6 0-1 .1-2 .4-3 1.3-3.9 1.6-7.4 1.6-12h-5c0 4.2-.3 7.6-1.3 10.8-.2.7-.3 1.3-.3 1.9 0 1.7 1.5 3.1 3.2 2.8 3.8-.6 6.5-3.3 6.9-6.6.4-3.4-2.1-6.1-5.5-6.1H106Z"
                    fill="url(#goldGrad)"
                  />
