...
const GRID_TEMPLATE =
  "grid grid-cols-[36px_1fr_36px_36px] sm:grid-cols-[70px_1fr_70px_70px_70px_70px] md:grid-cols-[90px_1fr_90px_90px_90px_90px_90px_90px]";
...
const PlayerRowItem = memo(function PlayerRowItem({
  ...
  return (
    <div>
      ...
      {showLetter && (
        <div className="sticky top-[52px] sm:top-[60px] md:top-[64px] z-10 bg-zinc-900 border-y border-white/10 px-1 sm:px-3 md:px-6 py-1.5 sm:py-2 md:py-3 text-[10px] sm:text-xs md:text-sm font-bold text-white/70 tracking-widest">
          {letter}
        </div>
      )}
      ...
      >
        ...
        <div className="flex items-center justify-center">
          <div className="relative w-7 h-7 sm:w-12 sm:h-12 md:w-14 md:h-14 overflow-hidden rounded-md md:rounded-lg bg-white/5 border border-white/10">
            <PlayerImage
              src={displayPhoto}
        ...
        {players.length === 0 ? (
          ...
          <div className="w-full">
            ...
            <div className="sticky top-0 z-20 bg-zinc-950 border-b border-white/10 shadow-lg">
              <div
                className={`${GRID_TEMPLATE} ${GRID_GAPS} px-1 sm:px-3 md:px-6 py-2 sm:py-2.5 md:py-3 text-[9px] sm:text-[10px] md:text-xs font-semibold uppercase tracking-wider text-white/60`}
              >
