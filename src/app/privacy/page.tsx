            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-white/90 ml-2">
                  ...
                  <li><strong className="text-white">Αναλυτικά cookies:</strong> Χρησιμοποιούμε το Vercel Analytics για να κατανοούμε πώς χρησιμοποιείται η πλατφόρμα (ανώνυμα δεδομένα επισκεψιμότητας).</li>
                </ul>
                <p className="text-white/90 leading-relaxed mt-3">
                  Δεν χρησιμοποιούμε cookies διαφήμισης ή cookies τρίτων μερών για προβολή διαφημίσεων. Μπορείτε να διαχειριστείτε τα cookies μέσω των ρυθμίσεων του προγράμματος περιήγησής σας.
                </p>
              </div>
